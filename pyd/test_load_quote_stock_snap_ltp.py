...
#result = LoadQuoteStockSnapLTP.LoadQuote(file_path, file_head, file_code, "", list_info, dict_data) # 注意内存哦
result = LoadQuoteStockSnapLTP.LoadQuote(file_path, file_head, file_code, "600000, 000001, 600004, 000005", list_info, dict_data)
