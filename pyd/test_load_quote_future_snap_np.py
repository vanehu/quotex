...
#result = LoadQuoteFutureSnapNP.LoadQuote(file_path, file_head, file_code, "", list_info, dict_data) # 注意内存哦
result = LoadQuoteFutureSnapNP.LoadQuote(file_path, file_head, file_code, "au1606", list_info, dict_data)
#result = LoadQuoteFutureSnapNP.LoadQuote(file_path, file_head, file_code, "IF1603, ag1606, au1606", list_info, dict_data)
