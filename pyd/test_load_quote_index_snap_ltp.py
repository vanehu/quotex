...
#result = LoadQuoteIndexSnapLTP.LoadQuote(file_path, file_head, file_code, "", list_info, dict_data) # 注意内存哦
result = LoadQuoteIndexSnapLTP.LoadQuote(file_path, file_head, file_code, "000001, 399001, 399300", list_info, dict_data)
